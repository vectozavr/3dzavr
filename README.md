...
- Projections from 3D on 2D plane, movement and rotation of camera and meshes + Triangles clipping
...
- Collision detection
- Network system by SFML sockets

<h4>Installation:</h4>

0) [Video tutorial](https://vectozavr.ru/lesson?id_article=0)
