...
private:
    ...
    void start() override {
        ...
        auto skyboxBigClouds = ResourceManager::loadTriangleMesh(ObjectTag("skybox_big_clouds"), FilePath(
                "resources/obj/skybox/midday/skybox1Shape.obj"));
        auto skyboxSmallClouds = ResourceManager::loadTriangleMesh(ObjectTag("skybox_small_clouds"), FilePath(
                "resources/obj/skybox/midday/skybox2Shape.obj"));
        ...
        pointLight->addComponent<PointLight>(Vec3D(0),Color::LIGHT_YELLOW, 2);
        ...
        auto lightCube = std::make_shared<Object>(ObjectTag("LightCube"));
        auto lightCubeTriangleMesh = lightCube->addComponent<TriangleMesh>(TriangleMesh::Cube(0.1));
        ...
        lightCube->getComponent<TransformMatrix>()->translateToPoint(Vec3D(0, 0.5, -5));
        lightCube->attach(pointLight);
        world->add(lightCube);
    };
